...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-vehicle';
        ...
        */
        ...
        return view('vehicle::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            ...
            'version' => config('settings.global.vehicle_version')??config('vehicle.version'),
            'is_dev' => config('vehicle.is_dev'),
        ];
