        ...
        <Panel class="is-small">
            ...
            <div v-if="store.item" class="mt-2">
                ...
                <VhField label="Phone Number">
                    <div class="p-inputgroup">
                        <InputNumber class="w-full"
                                   ...
                                   data-testid="customers-phone-number"
                ...
                <VhField label="Gender">
                    <Dropdown v-model="store.item.gender" :options="store.assets.genders" optionLabel="name" optionValue="slug" placeholder="Select a gender" class="w-full " />
                </VhField>

                <VhField label="Address">
                    <Textarea v-model="store.item.address" rows="5" cols="70" />
                </VhField>
